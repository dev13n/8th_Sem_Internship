...
- Collaborated with mentor to enhance **OCR** and **NLP** workflows using **Doctr** and **spaCy** for structured data extraction. 🧑‍💻
- Suggested incorporating **annotation tools** for manual validation of OCR outputs to improve training datasets. ✍️

## Day 16: Tuesday, 31/12/2024 - Toolbox Tuesday
- Participated in **Toolbox Tuesday**, an interactive session discussing Linde's core values, with a focus on **safety**. 🦺
- Discussed the integration of **safety measures** in data processing workflows and software development practices. 🔐
- Shared insights on how safety and quality measures could improve workflows, aligning with Linde's culture. 💬

## Day 17: Wednesday, 01/01/2025
- Tested **OCR models** on scanned PDFs with different resolutions and fonts. 📄
- Documented challenges in handling complex layouts and suggested strategies to improve data parsing. 📚

## Day 18: Thursday, 02/01/2025
- Integrated **tokenization methods** into preprocessing pipelines for **NLP models**. 🔄
- Researched methods to minimize errors caused by large tokenized input sequences, improving model efficiency. 🚀

## Day 19: Friday, 03/01/2025
- Debugged edge cases in text extraction where non-standard fonts were misclassified by the OCR pipeline. 🔍
- Worked with mentor to finalize solutions for reducing tokenization overhead, focusing on preprocessing and truncation strategies. 🔧
...
- Worked on improving the recognition accuracy of **handwritten** and **stylized fonts**. ✍️

## Day 23: Tuesday, 07/01/2025 - Toolbox Tuesday
- Participated in **Toolbox Tuesday**, discussing **teamwork**, **efficiency**, and **continuous learning**. 💡
- Contributed to a discussion on maintaining **data privacy** and **security** within Linde’s corporate framework. 🛡️

## Day 24: Wednesday, 08/01/2025
- Worked on **modularizing** the data processing pipeline to enhance scalability. 🏗️
- Integrated a **feedback loop** to refine extraction rules based on results from previous runs. 🔄

## Day 25: Thursday, 09/01/2025
- Experimented with **text segmentation algorithms** to reduce computational overhead in tokenization. ⚡
- Compared existing models to identify performance bottlenecks. 🏎️

## Day 26: Friday, 10/01/2025
- Ran performance benchmarks to assess **tokenization speed** and **accuracy** improvements. 📈
- Drafted a report summarizing challenges, improvements, and future optimization opportunities. 📝
...
- **Holiday (Makar Sankranti)** 🌾 (Family celebrations)

## Day 32: Thursday, 16/01/2025
- Finalized **tokenization** improvements and ran new benchmarks to check extraction accuracy with reduced tokens. 🎯
- Updated documentation for text extraction models to ensure clarity for future integrations. 📖

## Day 33: Friday, 17/01/2025
- Discussed **scalability** of text extraction models with mentor and team. 🔮
- Explored potential **cloud-based solutions** for efficient deployment of the pipeline. ☁️
...
- Continued optimizing preprocessing by adding **custom tokenization filters** and measuring improvements. ⚙️
- Worked with the team on strategies to **reduce manual intervention** in OCR validation. 🔧

## Day 37: Tuesday, 21/01/2025 - Toolbox Tuesday
- Participated in **Toolbox Tuesday**, focusing on **continuous improvement** and feedback loops. 🔄
- Discussed how principles of **continuous improvement** could be applied to both data extraction models and team processes at Linde. 💬

## Day 38: Wednesday, 22/01/2025
- Finalized **best practices** for the tokenization pipeline and prepared documentation for future reference. 📑
- Completed final testing on **OCR models** to ensure all edge cases were handled effectively. 🧪

## Day 39: Thursday, 23/01/2025
- Drafted an overview of the **OCR and tokenization project** for an upcoming presentation to senior management. 🎤
- Compiled results showing **performance improvements** and **model efficiency**. 📊

## Day 40: Friday, 24/01/2025
- Presented progress on the **OCR** and **NLP** pipeline improvements to the team, focusing on **error reduction** and **tokenization efficiency**. 📈
